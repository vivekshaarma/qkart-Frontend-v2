...
router.post('/addresses', verifyAuth, (req, res) => {
    ...
    users.update(
        ...
        (err) => {
            ...
            console.log(`Address "${req.body.address}" added to user ${req.user.username}'s address list`)
...
router.delete('/addresses/:id', verifyAuth, async (req, res) => {
    ...
    index = await req.user.addresses.findIndex(
    ...
    users.update(
        ...
        (err) => {
            ...
            console.log(`Address with id ${req.user._id} deleteed from user ${req.user.username}'s address list`)
